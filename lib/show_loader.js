...
//     
//     // Figure out if this user has starred this series
//     if ( Meteor.user() ) {
//       let starred_show = StarredShows.findOne({
//         userId: Meteor.userId(),
//         showId: show_id
//       });
//       
//       if ( starred_show ) show_info.starred = true;
//     }
//     
...
//         
//         console.log("Searching for episode", episode.id, "from user", Meteor.userId())
// 
//         
...
//     
//     console.log("Show loader finishd")
//     
//     return callback();
//     
//   }, (reason) => {
